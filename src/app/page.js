export default function Home() {
  return (
    <section className="bg-colors-background2 p-5 mt-4 rounded-lg flex flex-col gap-8">
      <div className="flex flex-col">
        <h1 className="text-colors-textoPrincipal font-bold mb-2 text-2xl">
          Sobre mim
        </h1>
      ...
      <p className="text-colors-paragrafo text-base sm:text-lg">
        ...
        universidade, iniciei meu interrese pela ciências da computação,
